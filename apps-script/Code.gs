...
function setupSpreadsheet() {
  ...
  seedRowsIfMissing(courseSheet, [
    ['BIOSTAT', 'Biostatistics and Epidemiology'],
    ['SSA', 'Statistical Software Application'],
    ['AMA', 'Applied Multivariate Analysis']
  ]);

  seedRowsIfMissing(lessonSheet, [
    ['lesson-01', 'Welcome to the Course — MLS BE 201', 'Chapter 1', 'BIOSTAT'],
    ['lesson-02', 'Variables, Measurement Scales, Data Collection & Sampling', 'Chapter 1', 'BIOSTAT'],
    ['lesson-01', 'Welcome to the Course — MAS 303a', 'Chapter 1', 'SSA'],
    ['lesson-02', 'R & RStudio Orientation', 'Chapter 1', 'SSA'],
    ['lesson-03', 'SPSS Orientation', 'Chapter 1', 'SSA'],
    ['lesson-01', 'Welcome to the Course — MAS 305a', 'Chapter 1', 'AMA'],
    ['lesson-02', 'Hypothesis Testing & Distribution Overview', 'Chapter 1', 'AMA']
  ]);
